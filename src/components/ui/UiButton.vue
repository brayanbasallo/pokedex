  ...
  <button
    ...
    :class="[
      rounded ? 'px-2.5 w-11 h-11' : 'px-5 py-2.5',
      {
        ...
        'bg-white hover:bg-secondary-dark text-golden disabled:text-gray-200': variant === 'secondary',
        'bg-white hover:bg-secondary-dark text-gray-300 disabled:text-gray-200': variant === 'tertiary'
      }
    ]" :disabled="disabled">
